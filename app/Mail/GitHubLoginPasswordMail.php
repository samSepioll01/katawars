...
class GitHubLoginPasswordMail extends Mailable
{
    ...
    public function envelope()
    {
        return new Envelope(
            ...
            subject: 'Katawars Password for GitHub Login Account',
        );
    }
    ...
    public function content()
    {
        return new Content(
            ...
            with: [
                ...
                'introLines' => [
                    'This is your provisional password that you can use instead GitHub Login.',
                ],
                'outroLines' => [
