<x-app-layout>
    <div>
        <div class="bg-white dark:bg-slate-800/70 p-8 rounded-md w-full shadow-xl">
            <div>
                <h3 class="text-gray-800 dark:text-slate-100 text-2xl font-semibold">Scores</h3>
            </div>
            ...
            <div class=" flex items-center justify-between pb-6">
                ...
                <div class="w-full grid grid-cols-12">
                    <div class="col-span-12 lg:col-span-8 py-5">
                        <x-layout.searcher-sync route="{{ route('scores.index') }}" />
                    </div>
                                            ...
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <a href="{{ route('scores.show', $score) }}">
                                                    <p class="text-gray-900 whitespace-no-wrap">
                                                        {{ ucwords($score->denomination) }}
                                                    </p>
                                                </a>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                                                <span>{{ ucwords($score->type) }}</span>
                                            </td>
                                            <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
