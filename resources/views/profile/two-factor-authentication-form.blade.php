    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            ...
            @if ($showingRecoveryCodes)
                ...
                <div class="grid gap-1 max-w-xl mt-4 px-4 py-4 font-mono text-sm text-gray-600 dark:text-slate-100 border border-gray-200 dark:border-gray-700 bg-slate-50 dark:bg-gray-900/90 rounded-lg">
